	...
	PrintSelectedMessages: async function (options) {
		...
		if (printingtools.num == 1 && options.printSilent == false && !autoPDFSave) {
			...
			if ( url !== "undefinedURL") {
				...
				let mail3PaneTabBrowser1a = window.document.getElementById("mail3PaneTabBrowser1")
				console.log(mail3PaneTabBrowser1)

				//let messagePanea = mail3PaneTabBrowser1a.getElementById("messagePane")
				//console.log(messagePanea)
				// gTabmail.currentTabInfo.chromeBrowser.contentDocument.getElementById("messagepane").contentDocument

				let messagePane = mail3PaneTabBrowser1.getElementById("messagePane")
				console.log(messagePane)
				console.log(messagePane.contentDocument)
				...
				printingtools.previewDoc = gTabmail.currentTabInfo.chromeBrowser.contentDocument.getElementById("messagepane").contentDocument
